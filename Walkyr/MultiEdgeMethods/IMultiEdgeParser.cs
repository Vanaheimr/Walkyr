...
namespace org.GraphDefined.Vanaheimr.Walkyr
{
    ...
    /// <summary>
    /// An interface for deserializing generic property multiedges.
    /// </summary>
    ...
    /// 
    /// <typeparam name="TFormat">The I/O-format of the deserializer.</typeparam>
    public interface IMultiEdgeParser<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
...

    {
        ...
        /// <summary>
        /// Deserialize the given serialized multiedge.
        /// </summary>
        /// <param name="Graph"></param>
        /// <param name="SerializedMultiEdge"></param>
