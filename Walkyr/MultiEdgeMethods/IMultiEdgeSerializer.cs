...
namespace org.GraphDefined.Vanaheimr.Walkyr
{
    ...
    /// <summary>
    /// An interface for serializing multiedges.
    /// </summary>
    ...
    public interface IMultiEdgeSerializer<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
...

    {
        ...
        /// </summary>
        /// <param name="MultiEdge">An multiedge.</param>
        TReturnFormat Serialize(IReadOnlyGenericPropertyMultiEdge<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
                                                                  TIdEdge,      TRevIdEdge,      TEdgeLabel,      TKeyEdge,      TValueEdge,
                                                                  TIdMultiEdge, TRevIdMultiEdge, TMultiEdgeLabel, TKeyMultiEdge, TValueMultiEdge,
