...
namespace org.GraphDefined.Vanaheimr.Walkyr
{
    ...
    /// <summary>
    /// An interface for deserializing generic property vertices.
    /// </summary>
    ...
    public interface IVertexParser<TIdVertex,    TRevIdVertex,    TVertexLabel,    TKeyVertex,    TValueVertex,
...

    {
        ...
        /// <summary>
        /// Deserialize the given serialized vertex.
        /// </summary>
